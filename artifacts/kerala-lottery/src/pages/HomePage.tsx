  ...
  return (
    <main className="page">
      ...
      <div className="container">
        <div className="notice">கேரளா லாட்டரி முடிவுகள் தினமும் மதியம் 3 மணிக்கு இங்கே புதுப்பிக்கப்படும். உங்கள் லாட்டரியைத் தேர்ந்தெடுத்து இன்றைய முடிவைப் பாருங்கள்.<br /><span style={{ opacity: 0.8, fontSize: 13 }}>Today's lottery mudivugal, innathe lottari result &amp; kulukkal outcome — all here.</span></div>
