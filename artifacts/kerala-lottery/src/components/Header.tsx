  ...
  return (
    <>
        ...
        <nav className="container nav" aria-label="Main navigation">
          ...
          <div className="nav__links nav__links--desktop">
            ...
            {mainLotteries.map((lottery) => (
              <Link key={lottery.slug} href={`/results/${lottery.slug}`}>{lottery.name}</Link>
            ))}
        ...
        {menuOpen && (
          <div className="mobile-menu" role="dialog" aria-label="Mobile navigation">
            ...
            <div className="mobile-menu__section">
              ...
              <Link href="/check-ticket" className="mobile-menu__item" onClick={() => setMenuOpen(false)}>
                🎟️ Check Ticket
              </Link>
              <Link href="/claim-guide" className="mobile-menu__item" onClick={() => setMenuOpen(false)}>
                📋 Claim Guide
              </Link>
              <Link href="/guessing-numbers" className="mobile-menu__item" onClick={() => setMenuOpen(false)}>
                🔢 Guessing Numbers
              </Link>
              <Link href="/download-forms" className="mobile-menu__item" onClick={() => setMenuOpen(false)}>
                📄 Download Forms
              </Link>
            </div>
            <div className="mobile-menu__section">
      ...
      <nav className="mobile-quickbar" aria-label="Mobile quick navigation">
        ...
        <Link
          href="/"
          className={location === '/' || location.startsWith('/results') ? 'active' : ''}
        >
          <span>🎯</span> Results
        </Link>
