...
export const metadata: Metadata = {
  title: 'Kerala Lottery Guessing Numbers Tamil',
  description: 'Entertainment-only Kerala Lottery guessing numbers in Tamil and English with responsible lottery disclaimer.'
};
