      ...
      <div className="container">
        ...
        <section className="section">
          ...
          {selectedLottery && selectedResult ? (
            <div
              className="selected-result-panel"
              style={{ borderColor: color.border, '--result-color': color.primary } as React.CSSProperties}
            >
            ...
            <div className="selected-result-panel" style={{ borderColor: color.border }}>
