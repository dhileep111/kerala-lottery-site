...
# ── Per-lottery prize amounts (verified against official Kerala govt PDFs 2026) ──
LOTTERY_PRIZES = {
    # Monday
    "bhagyathara": [
        ...
        {"tier": "8th Prize",        "amount": "\u20b9200"},
        {"tier": "9th Prize",        "amount": "\u20b9100"},
    ],
    # Tuesday
    "sthree-sakthi": [
        {"tier": "1st Prize",        "amount": "\u20b91,00,00,000"},
    ...
    # Wednesday — DL: 2nd=10L, 3rd=5L (NOT 5000), all 9 tiers
    "dhanalekshmi": [
        {"tier": "1st Prize",        "amount": "\u20b91,00,00,000"},
        {"tier": "Consolation Prize","amount": "\u20b95,000"},
...
TIER_MAP = {
    ...
    "9th":"9th Prize","ninth":"9th Prize","9":"9th Prize",
}
